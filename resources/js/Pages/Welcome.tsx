    ...
    return (
        <>
            ...
            <div className="relative m-0 box-border p-0 text-black">
                <header className="h-30 sticky left-0 top-0 z-10 w-1/2 bg-purple-500">
                    <nav className="">Navbar</nav>
                </header>
                <div className="absolute left-0 top-0 h-screen w-2/3 bg-black"></div>
                <main className="static h-[1024px] bg-slate-800">
                    Main Content
                </main>
                <footer className="relative h-24 w-full bg-[#0B3756]">
                    Footer
                </footer>
            </div>
        </>
